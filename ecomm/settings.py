...
SITE_ID = 1  # Changed from 2 to 1 (default)
...
# Email Configuration - Professional Setup for Portfolio Projects
if DEBUG:
    # Development: Use console backend to show emails in terminal
...
EMAIL_SUBJECT_PREFIX = '[Django eCommerce] '
